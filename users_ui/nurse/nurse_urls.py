...
urlpatterns = [
    ...
    path('upload-checkup/', nurse_views.nurse_upload_checkup, name='upload_checkup'),
    path('upload-rekomendasi/', manager_views.upload_rekomendasi_xls, name='upload_rekomendasi_xls'),  # Reuse manager logic
    path('download-rekomendasi-template/', manager_views.download_rekomendasi_template, name='download_rekomendasi_template'),
    ...
    path('export-karyawan-data/', manager_views.export_master_karyawan_excel, name='export_karyawan_data'),
